...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			STATIC_URL + 'lightbox/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			STATIC_URL + 'lightbox/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			STATIC_URL + 'lightbox/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			STATIC_URL + 'lightbox/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				STATIC_URL + 'lightbox/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
