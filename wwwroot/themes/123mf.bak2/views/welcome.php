...
<body>
    ...
    <div class="n-h5"></div>
    <div class="n-same" onclick="window.location = '<?=$this->url('controller=page&action=detail&code='.$this->video['code'])?>'">
    	<div class="n-smae-l">
    ...
    <div class="n-same" onclick="window.location = '<?=$this->url('controller=page&action=detail&code='.$this->todaynews['code'])?>'">
        <div class="n-smae-l">
            ...
            <p><?=$this->cutstr($this->todaynews['content'], 70)?></p>
        </div>
        <div class="n-same-r"></div>
    </div>
     <div class="n-h5"></div>
    <div class="n-same" onclick="window.location = '<?=$this->url('controller=page&action=detail&code='.$this->description['code'])?>'">
        <div class="n-smae-l">
            ...
            <p><?=$this->cutstr($this->description['content'], 70)?></p>
        </div>
        <div class="n-same-r"></div>
    </div>
    <div class="n-h5"></div>
    <div class="n-lise-16 clear">
        <?php 
        $cn = array('一','二','三','四','五','六','七','八');
        $i=0; foreach($this->quickLinks as $row) { ?>
    	<span>
    ...
    <div class="n-smae-l">
        ...
        <p><?=$this->cutstr($this->guide['content'], 70)?></p>
    </div>
    <div class="n-same-r"></div>
    </div>
    <div class="n-h5"></div>
    <div class="n-shop">
        ...
        <div class="n-shop-l">
            <ul>
                ...
                <li class="n-shop-l-te"><a href="<?=$this->url('/shop/list')?> ">更多</a></li>
            </ul>
        </div>
    </div>
    	...
    	<div class="n-pro-l">
    		...
    		<div class="n-pro-l-te">
    			<ul>
                    ...
                    <li><strong>现金+免费积分:￥</strong><span><?=$row['skus'][0]['exts']['ext1']['cash']?></span><p>+</p><span><?=$row['skus'][0]['exts']['ext1']['point']?></span><p>积分</p></li>
                    <?php } ?>
                    <?php if ($row['skus'][0]['exts']['ext2']['cash']) { ?>
                    <li><strong>现金+免费积分:￥</strong><span><?=$row['skus'][0]['exts']['ext2']['cash']?></span><p>+</p><span><?=$row['skus'][0]['exts']['ext2']['point']?></span><p>积分</p></li>
                    <?php } ?>
                    <li><strong>原价：￥</strong><span><?=$row['skus'][0]['market_price']?></span><p>积分</p></li> 
    			</ul>
    		</div>
    	</div>
        <?php } ?>
    </div>
    <div class="n-more"><a href="<?=$this->url('goods/channel?id='.$cate['id'])?> ">更多</a></div>
    <div class="n-h5"></div>
    <?php } ?>
    </div>
