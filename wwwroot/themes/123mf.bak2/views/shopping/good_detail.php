		...
		<div class="boline">
			<div class="discount-box w90">
				...
				<label class="fl">
					...
					<p class="select"><input type="radio" name="price_type" value="3" />&nbsp;&nbsp;<?=$this->data->skus[0]['exts']['ext1']['cash']?> RMB + <?=$this->data->skus[0]['exts']['ext1']['point']?> 免费积分</p>
					<?php } ?>
					<?php if ($this->data->skus[0]['exts']['ext2']['cash']) { ?>
					<p class="select"><input type="radio" name="price_type" value="4" />&nbsp;&nbsp;<?=$this->data->skus[0]['exts']['ext2']['cash']?> RMB + <?=$this->data->skus[0]['exts']['ext2']['point']?> 积分币</p>
					<?php } ?>
				</label>
				<p class="original fl">原  价:&nbsp;&nbsp;<span>¥<?=$this->data->skus[0]['market_price']?> RMB</span></p><p class="selled fr">已售  <?=$this->data['sales_num']?>件</p>
				<div class="clear"></div>
			</div>
		</div>
		<!-- <div class="boline">
