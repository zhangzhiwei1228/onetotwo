...
<body>
	...
	<div class="n-member">
		<div class="n-member-banner">
			<img src="<?php echo static_file('mobile/img/img-22.jpg'); ?> " alt="">
		</div>
		<div class="n-member-te">
			...
			<br>
			<p style="color:#333;line-height:24px;">C：二星分销商可推荐商家合作，推荐合作的商家的会员（一、二级会员），每个会员每次消费积分币时，二星分销商可获得相应的提成。</p>
			<br>
			<p style="color:#333;line-height:24px;">D：三星分销商可推荐商家合作，三星分销商可获得商家每月使用的免费积分的提成。</p>
		...
		<div class="n-member-input">
			<input value="立即申请" class="n-member-input1" type="submit" onclick="window.location='<?=$this->url('./apply?vip=3')?>'">
		</div>
	</div>
	<div class="n-h56"></div>
