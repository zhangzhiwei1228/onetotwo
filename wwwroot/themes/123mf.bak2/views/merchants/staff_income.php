...
<body class="bgcolor">
    ...
    <div class="z-jifenheader bgcolor<">
		<div class="header-merchants">
			<div class="main"><a href="#"><img src="<?php echo static_file('m/img/icon18.png'); ?> "></a>商家员工</div>
		</div>
	</div>
	...
	<div class="staff-jifen bgwhite"><p class="w90">我员工发展的二级会员消费积分币：<span class="fr"><em>10000</em>&nbsp;币</span></p></div>
